...
public class SimpleHalfPieChart extends View {
     ...
     * 中心文字大小
     */
    private float centerTextSize = DensityUtil.sp2px(16f);
    /**
     * 中心文字距底部的距离
     */
    private int distanceBetweenCenterTextAndBottom = DensityUtil.dp2px(20);
    /**
     * 文字与指示线之间的距离
     */
     ...
     * 延长线长度
     */
    private int lengthOfExtensionLine = DensityUtil.dp2px(15);
    /**
     * 折线长度
     */
    private int lengthOfBrokenLine = DensityUtil.dp2px(10);
    /**
     * 线宽
     */
    private int lineWidth = DensityUtil.dp2px(1.5f);
    /**
     * 宽度
     */
    private int width;
    ...
    public static class SimpleHalfPieChartBean {
        private String text;
        private float textSize = DensityUtil.dp2px(12);
        private int textColor = Color.parseColor("#4A4A4A");
        private int textStyle = Typeface.NORMAL;
        private String ratio;
        private float ratioSize = DensityUtil.dp2px(12);
