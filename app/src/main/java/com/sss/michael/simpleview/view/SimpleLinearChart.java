...
public class SimpleLinearChart extends View {
     ...
     * 坐标点与坐标点注释之间的间距
     */
    private int betweenDataTextAndPoint = DensityUtil.dp2px(10);
    /**
     * X轴与文字之间的间距
     */
    private int betweenRemartTextAndXAxis = DensityUtil.dp2px(15);
    /**
     * Y轴最大值
     */
    private int yMax;
     ...
     * X轴标签区域高度
     */
    private int xAxisLabelHeight = DensityUtil.dp2px(25);
    /**
     ...
     * 坐标点半径
     */
    private int pointRadius = DensityUtil.dp2px(3.5f);
    /**
     * 背景色
     */
     ...
     * 线宽
     */
    private float lineWidth = DensityUtil.dp2px(1.3f);
    /**
     * 画笔
     */
    ...
    public static class SimpleLinearChartBean {
        ...
        private float dataTextSize = DensityUtil.dp2px(12);
        private int dataTextColor = Color.parseColor("#2678E3");
        private float remarkTextSize = DensityUtil.dp2px(11);
